...
<link rel="stylesheet" href="template/css/angular-gridster.min.css"/>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-resize/1.1/jquery.ba-resize.min.js"></script>
  <script src="template/js/angular-gridster.min.js"></script>
  <link rel="stylesheet" href="template/css/slog.css" type="text/css" />
  
  <script src="template/js/angularjs.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/angular-filter/0.5.16/angular-filter.js"></script>
 
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.nicescroll/3.7.6/jquery.nicescroll.js"></script>
  <script src="template/js/funkcije.js"></script>
